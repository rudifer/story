var app = angular.module('App', ['ngSanitize', 'sticky']);


app.controller('mainController', function($scope,$http,$sce,$location) {

  $scope.story = function() {

	  var dataUrl = 'http://story.deoliveiradesign.com/wp-json/posts';
	  // console.log(dataUrl)
	  $http.get(dataUrl, { cache: true})
      .success(function(data) {
				$scope.stories = data
				// console.log($scope.stories)
				// not quite the logic but data extraction happening in view
      })
	}
      ...
      return {
        ...
        link: function linkFn($scope, $elem, $attrs) {
          ...
          $scope.initSticky = function () {
            ...
            angular.element($window).on('scroll', $scope.$apply.bind($scope, $scope.onResize));
